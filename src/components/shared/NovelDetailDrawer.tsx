            ...
            <div className="p-4 space-y-5">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h2 className="font-bold text-base leading-snug line-clamp-3 mb-1">
                    {novel.title}
                  </h2>
              ...
              {/* Stats grid */}
              {(() => {
                const stats = computeNovelStats(novel);
                ...
                return (
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      ...
                      <div
                        key={label}
                        className="surface-elevated rounded-lg p-3 flex items-center gap-2"
                      >
                    ...
                    <>
                      <div>
                        ...
                        <span className="text-foreground font-mono">
                          {stats.firstAppearDate ?? "-"}
                        </span>
                      </div>
                      <div>
                        차트아웃:{" "}
                        <span className="text-foreground font-mono">
                          {stats.lastChartOutDate ?? "-"}
                        </span>
                      </div>
                      <div>
                        최저 순위:{" "}
