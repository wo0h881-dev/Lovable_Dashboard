        ...
        <>
          ...
          >
            ...
            <div className="p-5 space-y-6">
              ...
              <div className="space-y-3">
                <h3 className="text-[11px] font-bold text-slate-500 uppercase tracking-widest flex items-center gap-1.5">
                  <MessageCircle size={14} /> 누적 {novel.platform === 'ridi' ? '평가수' : '조회수'} 추이
                </h3>
                <div className="bg-white/5 rounded-xl p-4 border border-white/5 h-[140px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={viewsData}>
                      ...
                      <Tooltip 
                        contentStyle={{ background: '#1e1e22', border: 'none', borderRadius: '8px', fontSize: '12px' }}
                        formatter={(value: number) => [formatViews(novel.platform, value), "누적 수치"]}
                      />
                ...
                <div className="bg-white/5 rounded-xl p-4 border border-white/5 space-y-3 text-xs">
                  <div className="grid grid-cols-2 gap-4 pb-3 border-b border-white/5">
                    <div className="space-y-1">
                      <p className="text-[10px] text-slate-500">역대 최고 순위</p>
                      <p className="text-sm font-bold text-amber-400 font-mono">#{stats.bestRank || novel.peakRank}위</p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-[10px] text-slate-500">역대 최저 순위</p>
                      <p className="text-sm font-bold text-slate-400 font-mono">#{stats.worstRank || '-'}위</p>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500">마지막 차트아웃</span>
                    <span className="text-rose-400 font-mono">{stats.lastChartOutDate || '현재 차트인'}</span>
                  </div>
                </div>
              </div>
